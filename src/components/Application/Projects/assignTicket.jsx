...
import { Grid, Paper, Typography, Button, Box, Icon } from '@mui/material';
    ...
    return (
        <>
            ...
            <Paper elevation={3} sx={{ p: 3 }}>
                ...
                <Grid container justifyContent="space-evenly" alignItems="center" sx={{ border: 1, borderRadius: 2, p: 1, mt: 3 }}>
                    <Box >
                        <Typography >
                    ...
                    <Box >
                        <Typography >
                            Selected Ticket: {selectedTicket.title}
                        </Typography>
