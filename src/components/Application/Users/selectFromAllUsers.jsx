...
import { Paper, Table, TableCell, Typography, Box, TableRow, TableHead, TableBody, TextField, CircularProgress, IconButton } from '@mui/material';
                        ...
                        allUsers && allUsers.map((user, i) => (
                            ...
                            >
                                ...
                                <ContentTableCell align="center">
                                    <IconButton onClick={() => handleAddSelectedUser(user._id, user.name, user.email)}>
                                        <AddIcon />
                                    </IconButton>
                                </ContentTableCell>
                            </TableRow>
